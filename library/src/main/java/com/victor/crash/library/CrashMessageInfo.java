...
public class CrashMessageInfo implements Parcelable {
    ...
    protected CrashMessageInfo(Parcel in) {
    ...
    public static final Creator<CrashMessageInfo> CREATOR = new Creator<CrashMessageInfo>() {
        @Override
        public CrashMessageInfo createFromParcel(Parcel in) {
            return new CrashMessageInfo(in);
        }

        @Override
        public CrashMessageInfo[] newArray(int size) {
            return new CrashMessageInfo[size];
        }
    };
